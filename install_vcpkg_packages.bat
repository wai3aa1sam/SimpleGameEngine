...
@REM externals\vcpkg\vcpkg install fmt:x64-windows --recurse
@REM externals\vcpkg\vcpkg install eastl:x64-windows --recurse
@REM externals\vcpkg\vcpkg install glew:x64-windows --recurse
@REM externals\vcpkg\vcpkg install nlohmann-json:x64-windows --recurse
@REM externals\vcpkg\vcpkg install libpng:x64-windows --recurse
@REM externals\vcpkg\vcpkg install imgui:x64-windows --recurse
@REM externals\vcpkg\vcpkg install tracy:x64-windows --recurse
