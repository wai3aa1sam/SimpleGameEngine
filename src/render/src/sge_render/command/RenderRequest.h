...
//	Mat4f		matrix_model;
	...
	void drawLine	(Vec3f pt0, Vec3f pt1, const Color4b& color = Color4b(255, 0, 255, 255));
	...
	void drawBoundingBox(const BBox3f&        bbox, const Color4b& color = Color4b(255, 0, 255, 255), const Mat4f& mat = Mat4f::s_identity());
	void drawBoundingBox(const RenderMesh&    mesh, const Color4b& color = Color4b(255, 0, 255, 255), const Mat4f& mat = Mat4f::s_identity());
	void drawBoundingBox(const RenderSubMesh& mesh, const Color4b& color = Color4b(255, 0, 255, 255), const Mat4f& mat = Mat4f::s_identity());
	void drawBoundingBox(const Vec3f& pos, const Vec3f& size, const Color4b& color = Color4b(255, 0, 255, 255));
